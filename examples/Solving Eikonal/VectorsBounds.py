...
plth.addVectorFieldPlot(fig2, MyMesh.vertices, MyMesh.triangles, FMTuSolv.fieldValues.computeVertexGradientFlow(), color=[255,127,0,0.5])
plth.addVectorFieldPlot(fig2, MyMesh.vertices, MyMesh.triangles, FMTCSolv.fieldValues.computeVertexGradientFlow(), color=[0,255,0,0.5])
plth.addVectorFieldPlot(fig2, MyMesh.vertices, MyMesh.triangles, FMEsolv.fieldValues.computeVertexGradientFlow(), color=[0,0,255,0.5])

plth.addVectorFieldPlot(fig2, MyMesh.vertices, MyMesh.triangles, ConstantVectorField, color=[255,0,0,0.5])
