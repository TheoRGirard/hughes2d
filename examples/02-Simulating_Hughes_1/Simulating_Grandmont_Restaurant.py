...
MyMesh = Mesh2D.Mesh()
MyMesh.generateMeshFromDomain(MyDomain, 0.02)
MyMesh.show()
MyMesh.saveToJson("examples/02-Simulating_Hughes_1/data/RuGrandmont")
...
opt = dict(model = "hughes",
            filename = "examples/02-Simulating_Hughes_1/data/RuGrandmont",
            save = True,
