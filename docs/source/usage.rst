...
.. note::
  If both *matplotlib* and *plotly*, the default preference is set to *plotly*.
...
If you don't have uv installed, you can see a list of the dependencies in the _pyproject.toml_ file (or below).
...
.. image:: assets/square_domain.png
...
.. note::
  Be careful: the generation time is inversely proportional to *dx*. Also the generation time explodes as *da* goes to 45.

You can visualize the mesh by using `MyMesh.show()` and obtain something like:

.. image:: assets/mesh_generated.png
...
.. image:: /assets/constant_circle.png
